...
DATA_CSV      = config.FORECAST_DATA_CSV
RESULTS_DIR   = config.FORECAST_RESULTS_DIR
ARTIFACTS_DIR = config.FORECAST_ARTIFACTS_DIR
CACHE_DIR     = Path(".gridsearch_cache_backtest") # Keep this as a local temp folder
